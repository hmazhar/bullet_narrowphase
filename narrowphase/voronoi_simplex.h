...
#ifndef VORNONOI_SIMPLEX_H
#define VORNONOI_SIMPLEX_H
...
struct btSubSimplexClosestResult {
  ...
  void setBarycentricCoordinates(real a = real(0.), real b = real(0.), real c =
      real(0.), real d = real(0.)) {
...
public:
  VoronoiSimplex() : m_equalVertexThreshold(VORONOI_DEFAULT_EQUAL_VERTEX_THRESHOLD) {}
  void reset();
