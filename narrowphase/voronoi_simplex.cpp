...
void VoronoiSimplex::removeVertex(int index) {
...
void VoronoiSimplex::reduceVertices(const btUsageBitfield& usedVerts) {
...
// add a vertex
void VoronoiSimplex::addVertex(const real3& w, const real3& p, const real3& q) {
  m_lastW = w;
  m_needsUpdate = true;
...
bool VoronoiSimplex::updateClosestVectorAndPoints() {
...
bool VoronoiSimplex::closest(real3& v) {
  bool succes = updateClosestVectorAndPoints();
  v = m_cachedV;
  return succes;
}

real VoronoiSimplex::maxVertex() {
...
int VoronoiSimplex::getSimplex(real3* pBuf, real3* qBuf, real3* yBuf) const {
  int i;
...
bool VoronoiSimplex::inSimplex(const real3& w) {
  bool found = false;
  int i, numverts = numVertices();
  // real maxV = real(0.);
...
void VoronoiSimplex::backup_closest(real3& v) { v = m_cachedV; }

bool VoronoiSimplex::emptySimplex() const { return (numVertices() == 0); }

void VoronoiSimplex::compute_points(real3& p1, real3& p2) {
  updateClosestVectorAndPoints();
  p1 = m_cachedP1;
  p2 = m_cachedP2;
}

bool VoronoiSimplex::closestPtPointTriangle(const real3& p, const real3& a, const real3& b, const real3& c, btSubSimplexClosestResult& result) {
...
int VoronoiSimplex::pointOutsideOfPlane(const real3& p, const real3& a, const real3& b, const real3& c, const real3& d) {
...
bool VoronoiSimplex::closestPtPointTetrahedron(const real3& p, const real3& a, const real3& b, const real3& c, const real3& d, btSubSimplexClosestResult& finalResult) {
